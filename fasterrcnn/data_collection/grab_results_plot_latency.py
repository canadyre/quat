...
for m in mods:
    ...
    for at in attac:
        for bn in bnd:
            #print(df.first().loc[(m,'frcnn',at,bn)]['eval_time'])
...
plt.savefig('./plots/frcnn_attacks_evaltime.png')
#plt.show()
plt.clf()
...
plt.title('SSD300')
plt.tight_layout()
plt.savefig('./plots/ssd300_attacks_evaltime.png')
#plt.show()
...
plt.title('YOLO')
plt.tight_layout()
plt.savefig('./plots/yolo_attacks_evaltime.png')
#plt.show()
