...
plt.tight_layout()
plt.savefig('./plots/frcnn_attacks_jetson_evaltime.png')
#plt.show()
plt.clf()
...
plt.title('SSD300')
plt.tight_layout()
plt.savefig('./plots/ssd300_attacks_jetson_evaltime.png')
#plt.show()
...
plt.title('YOLO')
plt.tight_layout()
plt.savefig('./plots/yolo_attacks_jetson_evaltime.png')
#plt.show()
