import sys
import os
sys.path.append(os.path.abspath('/home/canadyre/Dropbox/IC2E_code/frcnn_utils/pytorch_faster_rcnn/lib'))
sys.path.append(os.path.abspath('/home/canadyre/Dropbox/IC2E_code/frcnn_utils/pytorch_faster_rcnn/tools'))
